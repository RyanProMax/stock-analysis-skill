...
- 模拟盘 dry-run 自动化默认路由到 `stock-analysis-api/scripts/trading_run_once.py`；cron / launchd / Agent 高频调用默认路由到 `stock-analysis-api/scripts/trading_scheduler_tick.py`；本 skill 不实现真实交易
